...
type UserServiceClient interface {
	...
	// logout
	Logout(ctx context.Context, in *LogoutRequset, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *userServiceClient) Logout(ctx context.Context, in *LogoutRequset, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type UserServiceServer interface {
	...
	// logout
	Logout(context.Context, *LogoutRequset) (*emptypb.Empty, error)
...
func (UnimplementedUserServiceServer) Logout(context.Context, *LogoutRequset) (*emptypb.Empty, error) {
...
func _UserService_Logout_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).Logout(ctx, req.(*LogoutRequset))
	}
	return interceptor(ctx, in, info, handler)
}
